...
exports.run = async (client, message, args) => {
  ...
  /*kılıç*/  if(!db.kontrol(`kılıç_${gösterilecek.id}`)) { var kılıç = "Yok" } else { var kılıç = db.bul(`kılıç_${gösterilecek.id}`) }
